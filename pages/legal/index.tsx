      ...
      <Container px="xs" py={112}>
        <Stack>
          ...
          <Text color="gray">
            ...
            of an entity (“you”) and Enfront LLC, doing business as Enfront (&quot;Enfront&quot;, &quot;we&quot;,
            &quot;us&quot;, or &quot;our&quot;), concerning your access to and use of the enfront.io website as well as
            any other media form, media channel, mobile website or mobile application related, linked, or otherwise
            connected thereto (collectively, the “Site”). We are registered in Missouri, United States. You agree that
            by accessing the Site, you have read, understood, and agree to be bound by all of these Terms of Use. IF YOU
          ...
          <Text color="gray">We accept the following forms of payment:</Text>
          ...
          <Text color="gray">
            ...
            of purchases as deemed required by us. We may change prices at any time. All payments shall be in Any.
          </Text>
          ...
          <Text color="gray">
            ...
            <Anchor href="mailto:support@enfront.io">support@enfront.io</Anchor> or visit the billing tab in on your
            dashboard.
          </Text>
          ...
          <Text color="gray">As a user of the Site, you agree not to:</Text>
          ...
          <Text color="gray">
            ...
            other users of the Site and through third-party websites. As such, any Contributions you transmit may be
          ...
          <Text color="gray">
            ...
            within the Department of Defense, our services are subject to the terms of these Terms of Use in accordance
            with Defense Federal Acquisition Regulation (“DFARS”) 227.7202‑3. In addition, DFARS 252.227‑7015 applies to
            technical data acquired by the DOD. This U.S. Government Rights clause is in lieu of, and supersedes, any
            other FAR, DFARS, or other clause or provision that addresses government rights in computer software or
          ...
          <Text color="gray">
            ...
            transferring your data to the United States, and you agree to have your data transferred to and processed in
            the United States.
          </Text>
          ...
          <Text color="gray">
            ...
            <Anchor href="www.adr.org">www.adr.org</Anchor>. Your arbitration fees and your share of arbitrator
            ...
            the arbitration will take place in St Peters, Missouri. Except as otherwise provided herein, the Parties may
          ...
          <Text color="gray">
            ...
            prosecuted in the state and federal courts located in St Peters, Missouri, and the Parties hereby consent
