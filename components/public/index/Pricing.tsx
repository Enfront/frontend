        ...
        <Button
          className={clsx(
            ...
            featured
              ...
              : 'border-slate-700 text-white ring-1 ring-slate-700 hover:border-slate-500 hover:bg-transparent',
          )}
      ...
      <Container size="xl">
        <div className="md:text-center">
          ...
          <p className="mt-4 text-lg text-slate-400">
            It doesn&apos;t matter what size your business is, we&apos;re here to help you.
          </p>
        </div>
        ...
        <div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:gap-x-8">
          <Plan
            ...
            href="/register"
            features={['1 shop', 'Unlimited products', 'Unlimited orders', 'Unlimited blacklist items', '2% Fees']}
          />
